...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='info@austradecommodities.com')
CONTACT_EMAIL = config('CONTACT_EMAIL', default='info@austradecommodities.com')
